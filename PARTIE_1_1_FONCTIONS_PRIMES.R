...
head(TH002)
# On ajoute la mortalité certaine en fin de table : 
TH002[nrow(TH002)+1,] = c(Age = nrow(TH002), Lx = 0 , qx = 1)
...
f_survie_age_x_plus_k <- function(age, nb_années,table_morta = TH002) {
  ...
  max_age = nb_années + indice_age_TM - 1
  v_survie = c()
  v_survie = table_morta[indice_age_TM : max_age, 2] / table_morta[indice_age_TM, 2]
  return(v_survie)
}
